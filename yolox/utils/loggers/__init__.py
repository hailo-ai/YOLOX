...
# from yolox.utils.general import LOGGER, colorstr, cv2
# from yolox.utils.loggers.clearml.clearml_utils import ClearmlLogger
# from yolox.utils.loggers.wandb.wandb_utils import WandbLogger
# from yolox.utils.plots import plot_images, plot_labels, plot_results
...
class Loggers():
    ...
    def __init__(self, save_dir=None, weights=None, opt=None, hyp=None, logger=None, include=LOGGERS):
        ...
        self.opt = opt
        self.hyp = hyp
        self.plots = False  # not opt.noplots  # plot results
